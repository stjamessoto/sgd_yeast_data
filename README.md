...
| **π Estimator** | Select k families; estimate $\vec{\pi}$ by any of the seven methods (four SGD-based: evidence codes, Moment Estimation, SNP divergence, consensus-adjusted; three Y1000+ cross-species: π₃ TFBS conservation, π₂ sequence homology, π₄ IC-weighted SNP at binding sites); sensitivity plot; expandable methodology guide explaining the Gamma-ratio formula and the biological rationale behind each estimation method |
